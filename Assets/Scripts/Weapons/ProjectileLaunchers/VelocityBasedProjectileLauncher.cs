...
public class VelocityBasedProjectileLauncher : MonoBehaviour
{
	...
	public void Shoot(VelocityBasedWeaponType velocityBasedWeaponType, Vector3 firingPointPos, Vector3 targetPos)
	{
		...
		// rozlozyc powyzsze na dwie wysokosci (jedna gdy gracz i przeciwnik sa na tym samym poziomie, druga gdy nie sa)
		...
		//Vector3 velocityWithAngle = Quaternion.AngleAxis(-angle, Vector3.right) * (directionToTarget * initialVelocity);
		Vector3 velocityWithAngle = Quaternion.AngleAxis(-angle, Vector3.right) * Vector3.up * initialVelocity;
	...
	public void Shoot2(VelocityBasedWeaponType velocityBasedWeaponType, Vector3 firingPointPos, Vector3 targetPos)
	{
		...
		velocityWithAngle = new Vector3(velocityWithAngle.x, velocityWithAngle.y-angle/2, velocityWithAngle.z);
